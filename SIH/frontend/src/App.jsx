...
import ManufacturersPage from './pages/admin/Manufacturers.jsx';
import ManufacturerDetail from './pages/admin/ManufacturerDetail.jsx';
  ...
  return (
    <Routes>
      ...
      <Route
        path="/inspections"
        element={
          <ProtectedRoute role={['SUPERVISOR', 'MANUFACTURER']}>
            <InspectionsPage />
          </ProtectedRoute>
        }
      />
