      ...
      <div className="flex items-center justify-between flex-wrap gap-3">
        <div>
          ...
          <p className="text-text-muted text-sm mt-0.5">
            Only admins can create supervisor accounts and activate them.
          </p>
        </div>
      ...
      <Card className="p-0 overflow-hidden">
        {loading ? (
          ...
          <EmptyState
            ...
            description="Invite your first supervisor to get started."
            action={<Button onClick={() => setShowForm(true)}>Invite supervisor</Button>}
          />
        ) : (
