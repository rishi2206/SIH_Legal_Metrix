...
public class PdfReportService {
    ...
    public String generateReport(UUID inspectionId, UUID supervisorId) {
        ...
        try {
            ...
            Paragraph subtitle = new Paragraph("Statutory LMPC Compliance Inspection Report");
            ...
            document.add(new Paragraph("Supervisor: " + inspection.getSupervisor().getName()));
            document.add(new Paragraph("Supervisor Email: " + inspection.getSupervisor().getEmail()));
